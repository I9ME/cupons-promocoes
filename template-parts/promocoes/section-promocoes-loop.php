<?php 
			...
			$newsArgs = array( 'post_type' => 'promocoes', 'posts_per_page' => $limit_post, 'orderby' => 'ID', 'order' => 'ASC');
			$newsLoop = new WP_Query( $newsArgs );
			
			if ( $newsLoop->have_posts() ): 

 		?>
	<ul class="Section-items u-size24of24 u-flex u-paddingVertical u-flexWrapWrap">
		<?php                     
