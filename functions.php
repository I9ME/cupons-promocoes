...
function skeleton_scripts() {
	...
	wp_enqueue_script( 'js-main', get_theme_file_uri( '/assets/js/main.min.js' ), array('jquery'), true );

	//wp_enqueue_script( 'js-jquery', get_theme_file_uri( '/assets/js/jquery-3.2.1.js' ), array(), null );
	...
	public function book_image_meta_box() {
       ...
       <!--  <tr id="Div1" class="contentTipo Div1 Div2 Div3 Div4 Div5 Div6 Div7" style="display: none;">
         ...
         <tr id="Div2" class="contentTipo Div1 Div2 Div3 Div4 Div5 Div6 Div7 Div8 Div9 Div10 Div11 Div12" style="display: none;">
            ...
            <td><input type="text" size="80" name="multimidia_value_line_3" value="<?php echo $value_line_3; ?>" /></td>
        </tr>
         <tr id="Div2" class="contentTipo Div1 Div2 Div3 Div4 Div5 Div6 Div7 Div8 Div9 Div10 Div11 Div12" style="display: none;">
            <td style="width: 100%"><strong>Quantidade Gerada</strong></td>
            <td><input type="text" size="80" name="multimidia_value_line_4" disabled="disabled" value="<?php echo $value_line_4; ?>" /></td>
        </tr>
